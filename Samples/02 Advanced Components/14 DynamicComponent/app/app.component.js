...
var AppComponent = (function () {
    ...
    AppComponent.prototype.injectTemplate = function () {
        var template = "<h1>{{state.counter}}</h1>";
        var componentFactory = this.createComponentFactory(template);
    ...
    AppComponent.prototype.createComponentFactory = function (template) {
        ...
        var moduleFactory = this.compiler.compileModuleAndAllComponentsSync(DynamicModule);
